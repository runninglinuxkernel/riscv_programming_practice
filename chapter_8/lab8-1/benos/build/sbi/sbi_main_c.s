...
.L4:
	...
	li	a5,2
	bne	a4,a5,.L5
	.loc 1 38 32 is_stmt 0 discriminator 1
	li	a5,16
	j	.L6
.L5:
	.loc 1 38 32 discriminator 2
	li	a5,24
.L6:
	.loc 1 38 7 is_stmt 1 discriminator 4
	ld	a4,-96(s0)
	or	a5,a4,a5
	sd	a5,-96(s0)
	.loc 1 41 21 discriminator 4
	lw	a5,-36(s0)
	li	a4,255
	sll	a5,a4,a5
	...
	not	a5,a5
	sd	a5,-48(s0)
	.loc 1 42 12 discriminator 4
	lw	a5,-32(s0)
	mv	a0,a5
	call	read_csr_num
	mv	a4,a0
	.loc 1 42 9 discriminator 4
	ld	a5,-48(s0)
	and	a5,a5,a4
	sd	a5,-56(s0)
	.loc 1 43 19 discriminator 4
	lw	a5,-36(s0)
	ld	a4,-96(s0)
	sll	a4,a4,a5
	.loc 1 43 38 discriminator 4
	ld	a5,-48(s0)
	not	a5,a5
	.loc 1 43 36 discriminator 4
	and	a5,a4,a5
	.loc 1 43 9 discriminator 4
	ld	a4,-56(s0)
	or	a5,a4,a5
	sd	a5,-56(s0)
