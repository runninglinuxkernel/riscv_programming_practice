...
#define SBI_GET_TIMER 1
#define SBI_CONSOLE_PUTCHAR 0x2
#define SBI_CONSOLE_GETCHAR 0x3
...
static inline unsigned long sbi_get_timer(void)
{
	unsigned long stime_value;

    stime_value = SBI_CALL_0(SBI_GET_TIMER);
    return stime_value;
}


static inline int sbi_putchar(int c)
{
